...
export const ru: LangType = {
    ...
    /*mine*/
    'page.body.landingmine.marketInfo.title.text1': 'SFOR.TRADE.',
    'page.body.landingmine.marketInfo.titleh2.text1': 'Cryptotrade is here. And it is here to start.', 
    'page.body.landing.register.item.titlesecon': 'Simple and secure',
    'page.body.landing.marketInfo.title.text2': 'We provide a secure platform for customers to access the opportunities of digital asset trading. Whether you’re an experienced player or just getting started, we give an institutional grade experience for all traders.',
    'page.body.landingmine.features.features.item1.text': 'SFOR.TRADE offers the most liquid order book, allowing users to easily exchange Bitcoin, Ethereum, EOS, Litecoin, Ripple, NEO and many other digital assets with minimal slippage.',
    ...
    'page.body.landing.register.item.title': 'Experience level',
    'page.body.landing.register.item.text': 'SFOR.TRADE offers an intuitive interface with real time orderbooks, charting tools, trade history, and a simple order process so you can trade from day one.',
    'page.body.landing.register.item.button': 'register',

    'page.body.landing.features.title': 'Security first',
    'page.body.landing.features.features.item1.title': 'User Protection',
    'page.body.landing.features.features.item2.title': 'System Security',  
    'page.body.landing.features.features.item1.text1': 'Add an extra layer of security to your account using two-factor authentication by Google Authenticator and IP Detector system.',
    'page.body.landing.features.features.item1.text2': 'Advanced verification tools to monitor the integrity of your account:',
    'page.body.landing.features.features.item1.text3': 'Login data is saved and analyzed for unusual activity.',
    'page.body.landing.features.features.item1.text4': 'Intelligent system detects IP Address changes to prevent session hijacking.',
    'page.body.landing.features.features.item1.text5': 'Email notifications report logins to instantly freeze your account if you suspect malicious activity.',
    'page.body.landing.features.features.item1.text6': 'Limit access to your account based on IP address.',
    'page.body.landing.features.features.item1.text7': 'Withdrawals protection with monitoring by IP address and other user behavior patterns, triggering manual admin inspection on withdrawals that appear unusual.',
    'page.body.landing.features.features.item1.text8': 'Withdrawal confirmation step that is immune to malicious browser malware.',
    'page.body.landing.features.features.item1.text9': 'Define an address whitelist to ensure no withdrawals can go anywhere else.',

    'page.body.landing.features.features.item2.text1': 'SFOR.TRADE is fully protected against TOP OWASP Vulnerabilities, incuding:',
    'page.body.landing.features.features.item2.text2': 'DDoS/Layer 7 DDoS Attacks;',
    'page.body.landing.features.features.item2.text3': 'Cross-site request forgery (CSRF);',
    'page.body.landing.features.features.item2.text4': 'Clickjacking attacks;',
    'page.body.landing.features.features.item2.text5': 'Cross Site Scripting (XSS) attacks;',
    'page.body.landing.features.features.item2.text6': 'Remote File Include (RFI);',
    'page.body.landing.features.features.item2.text7': 'MITM attacks;',
    'page.body.landing.features.features.item2.text8': 'Remote Code Execution (RCE);',
    'page.body.landing.features.features.item2.text9': 'Injection attacks and POODLE attacks, etc.',
    'page.body.landing.features.features.item2.text10': 'Automatic backup of the platforms database once a day and duplication of backup data automatically.',
    'page.body.landing.features.features.item2.text11': 'Our servers network is always protected with up-to-date Linux systems.',
    ...
    'page.body.landing.tradeOnTheGo.item.text3': 'All the power of SFOR.TRADE cryptocurrency exchange, in the palm of your hand.',
    ...
    'page.body.landing.footer.febugbountyes': 'Bug Bounty',
    'page.body.landing.footer.depositwithdrawal': 'Deposits & Withdrawals',
    ...
    'page.body.landing.footer.rights': 'Copyright © 2018 SFOR.TRADE All Rights Reserved | Created and Supported by', 
    ...
    'page.header.signUp.terms': 'Я согласен со всеми правилами и условиями.',
