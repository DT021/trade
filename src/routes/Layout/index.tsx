        ...
        return (
            <div className={`container-fluid pg-layout ${tradingCls}`}>
                <Switch>
                    ...
                    <Route exact={true} path="/aml" component={AmlPolicy} />
                    <Route exact={true} path="/bugbounty" component={BugBounty} />
                    <Route exact={true} path="/deposits" component={DepositsWithdrawals} />
                    <Route exact={true} path="/fees" component={FeesPolicy} /> 
                    <Route exact={true} path="/404" component={FortyFourScreen} />
                    <Route exact={true} path="/withdrawal" component={Withdrawals} />
